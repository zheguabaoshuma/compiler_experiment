...
{
       0,    43,    43,    44,    45,    48,    51,    52,    55,    59,
      63,    67,    71,    75,    77,    78,    79,    86,    87,    90,
      96,   104
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MINUS", "DIVIDE", "MOD", "TIMES", "INT", "FLOAT", "ID", "UMINUS", "';'",
  "'('", "')'", "'-'", "'='", "$accept", "lines", "stmt", "expr",
  "keyword", "decl", "assn", YY_NULLPTR
};
...
{
     -10,    19,   -10,   -10,   -10,   -10,    -9,   -10,     7,     7,
     -10,    37,     5,    -4,     4,     7,   -10,    32,   -10,     7,
       7,     7,     7,     7,   -10,     3,   -10,   -10,    -2,   -10,
      18,    18,   -10,   -10,   -10,     7,    -2
};
...
{
       4,     0,     1,     8,    17,    18,    16,     3,     0,     0,
       2,     0,     0,     0,     0,     0,    16,     0,    15,     0,
       0,     0,     0,     0,     5,    19,     6,     7,    21,    14,
       9,    10,    12,    13,    11,     0,    20
};
...
{
      17,    18,    19,    20,    21,    22,    23,    28,    15,    26,
       3,    30,    31,    32,    33,    34,    25,    27,    16,     2,
      35,     8,     3,     9,    21,    22,    23,    36,     4,     5,
       6,     0,     7,     8,     0,     9,    19,    20,    21,    22,
      23,    19,    20,    21,    22,    23,     0,    29,     0,     0,
      24
};

static const yytype_int8 yycheck[] =
{
       8,     9,     4,     5,     6,     7,     8,    15,    17,    13,
       3,    19,    20,    21,    22,    23,    11,    13,    11,     0,
      17,    14,     3,    16,     6,     7,     8,    35,     9,    10,
      11,    -1,    13,    14,    -1,    16,     4,     5,     6,     7,
       8,     4,     5,     6,     7,     8,    -1,    15,    -1,    -1,
      13
};
...
{
       0,    19,     0,     3,     9,    10,    11,    13,    14,    16,
      20,    21,    22,    23,    24,    17,    11,    21,    21,     4,
       5,     6,     7,     8,    13,    11,    13,    13,    21,    15,
