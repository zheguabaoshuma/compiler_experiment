...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NFASEGMENT = 14                 /* NFASEGMENT  */
};
...
static const char *const yytname[] =
{
  ...
  "BASICSEGMENT", "CONCAT", "'|'", "';'", "'*'", "'+'", "'?'", "$accept",
  "line", "NFASEGMENT", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* line: NFASEGMENT ';'  */
#line 23 "regex2nfa.y"
                        {display((yyvsp[-1].nfa_ptr));}
#line 1137 "y.tab.c"
    break;

  case 3: /* NFASEGMENT: NFASEGMENT CONCAT NFASEGMENT  */
#line 27 "regex2nfa.y"
                                        {
                ...
                state_ptr+=2;
                nfa_conjunction(nfa,(yyvsp[-2].nfa_ptr),(yyvsp[0].nfa_ptr));
                (yyval.nfa_ptr)=nfa;
